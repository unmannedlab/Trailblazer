...
config.NAME = 'segformer_train_512x512_adamw_lr5e-4_wd1e-2_bs_8_epoch400_scratch'
config.OUTPUT_DIR = 'outputs'
config.LOG_DIR = 'logs'

config.DATASET = CN()
config.DATASET.NAME = 'flair'
config.DATASET.DATA_DIR = '/media/usl/ssd_data/FLAIR/data/'
config.DATASET.INPUT_PATTERN = '*.png'
config.DATASET.ANNOT_PATTERN = '*.png'
config.DATASET.IMAGE_DIR = 'img'
config.DATASET.LABEL_DIR = 'cust_label'
...
config.DATASET.BASE_SIZE = (875,882)
config.DATASET.CROP_SIZE = (512, 512) # (768, 768)
